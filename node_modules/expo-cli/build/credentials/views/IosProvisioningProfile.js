...
class CreateProvisioningProfile {
  ...
  async open(ctx) {
    ...
    const appCredentials = (0, _find().default)(ctx.ios.credentials.appCredentials, app => app.experienceName === this._experienceName && app.bundleIdentifier === this._bundleIdentifier);
...
async function getProvisioningProfileFromParams(builderOptions) {
  ...
  if (!(0, _every().default)([provisioningProfilePath, teamId])) {
