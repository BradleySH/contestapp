...
class SetupIosPush {
  ...
  async open(ctx) {
    ...
    const appCredentials = await ctx.ios.getAppCredentials(this._experienceName, this._bundleIdentifier);
    const deprecatedPushId = (0, _get().default)(appCredentials, 'credentials.pushId');
    const deprecatedPushP12 = (0, _get().default)(appCredentials, 'credentials.pushP12');
    const deprecatedPushPassword = (0, _get().default)(appCredentials, 'credentials.pushPassword');
    ...
    const configuredPushKey = await ctx.ios.getPushKey(this._experienceName, this._bundleIdentifier);
