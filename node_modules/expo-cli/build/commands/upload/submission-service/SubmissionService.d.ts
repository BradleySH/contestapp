...
declare function startSubmissionAsync(platform: Platform, config: SubmissionConfig): Promise<StartSubmissionResult>;
declare function getSubmissionAsync(submissionId: string): Promise<Submission>;
