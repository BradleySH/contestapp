...
async function default_1(env, argv = {}) {
    ...
    if (isNative) {
        ...
        if (reactNativeModulePath) {
            appEntry = [
                path_1.default.join(reactNativeModulePath, 'Libraries/polyfills/console.js'),
                path_1.default.join(reactNativeModulePath, 'Libraries/polyfills/error-guard.js'),
                path_1.default.join(reactNativeModulePath, 'Libraries/polyfills/Object.es7.js'),
                path_1.default.join(reactNativeModulePath, 'Libraries/Core/InitializeCore.js'),
                ...appEntry,
            ];
        }
    }
    ...
    let webpackConfig = {
        ...
        context: isNative ? (_b = env.projectRoot) !== null && _b !== void 0 ? _b : __dirname : __dirname,
        ...
        plugins: [
            ...
            generatePWAImageAssets &&
                new plugins_1.ApplePwaWebpackPlugin({
                    ...
                    name: (_c = env.config.web) === null || _c === void 0 ? void 0 : _c.shortName,
                    isFullScreen: (_d = env.config.web) === null || _d === void 0 ? void 0 : _d.meta.apple.touchFullscreen,
                    isWebAppCapable: (_e = env.config.web) === null || _e === void 0 ? void 0 : _e.meta.apple.mobileWebAppCapable,
                    barStyle: (_f = env.config.web) === null || _f === void 0 ? void 0 : _f.meta.apple.barStyle,
        ...
        resolve: {
            ...
            extensions: env_1.getModuleFileExtensions(...getPlatforms((_g = env.platform) !== null && _g !== void 0 ? _g : 'web')),
            plugins: [
